let slideIndex = 1;
const slideTexts = [
    "Il teatro comunale di Ferrara &egrave; il pi&ugrave; importante teatro della citt&agrave;,<br>costruito tra il 1773 ed il 1797 su progetto di Antonio Foschini e Cosimo Morelli.<br>Si trova in corso Martiri della Libert&agrave;, in pieno centro storico a pochi metri dal Castello Estense.",
    "Questo magnifico teatro, con i suoi eleganti palchi decorati, soffitti affrescati e dettagli raffinati, rappresenta un capolavoro dell'architettura teatrale classica.<br>Un gioiello nel cuore della citt&agrave;, capace di trasportare ogni visitatore in un'epoca di splendore e raffinatezza.",
